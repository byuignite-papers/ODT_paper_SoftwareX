...
\title{One-dimensional turbulence (ODT): computationally efficient modeling of turbulent reacting flows}
...
\author{Victoria B. Stephens, David O. Lignell\footnote{Corresponding author.\\ \indent \textit{Email address}: davidlignell@byu.edu}}
